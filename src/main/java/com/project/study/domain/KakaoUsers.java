...
@Data
public class KakaoUsers implements OAuth2UserInfo{
	...
	public KakaoUsers(Map<String, Object> attributes) {
	...
	public String getName() {
		return (String) ((Map) attributes.get("properties")).get("username");
	}
